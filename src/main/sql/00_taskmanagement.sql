...
(
  	project_id               	bigint,
    user_id              		bigint,
    CONSTRAINT "FK_PROJECT_ID" FOREIGN KEY ("project_id") REFERENCES "tm"."project" ("id") ON UPDATE NO ACTION ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE,
	CONSTRAINT "FK_USER_ID" FOREIGN KEY ("user_id") REFERENCES "tm"."tmuser" ("id") ON UPDATE NO ACTION ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE
);